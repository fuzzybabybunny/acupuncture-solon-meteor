var faqContents = [
    ...
    answer: "<p>Common feelings during acupuncture are local distension, heaviness, numbness, soreness, or a sensation like a tiny electric shock. All of these feelings are mild. They indicate that the healing is in progress. Notify the acupuncturist if these feelings become uncomfortable. </p> <p> Most patients find the treatment very relaxing, which brings on a feeling of well being.Most are surprised at how comfortable they are during the treatment and how easily the needles are placed.Some people even go to sleep during the treatment.A patient may feel a slight sensation upon entry and then pressure or a“ dull” or“ surging” reaction when the needle reaches the“ Qi” or correct point. Rest assured, the needles are different from the hypodermic needles that are given in injections.The tiny needles are specifically designed to be virtually painless. </p>"
  }, {
  	number: "Six",
